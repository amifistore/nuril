...
import config
import database
import handlers  # Impor semua handler
import api_clients # Impor untuk menginisialisasi user_data global
import utils     # Impor untuk menginisialisasi variabel global

def shutdown_handler(sig, frame):
    """Menangani proses mematikan bot dengan aman."""
...
def main():
    ...
    # Inisialisasi dan memuat database
    database.inisialisasi_database()
    
    # Memuat data ke variabel global di modul yang membutuhkannya
    loaded_user_data = database.muat_data_dari_db()
    handlers.user_data = loaded_user_data
    api_clients.user_data = loaded_user_data
    
    # Inisialisasi waktu start bot
    ...
    # Handler utama untuk tombol dan teks
    ...
    # Menangani sinyal shutdown (Ctrl+C)
